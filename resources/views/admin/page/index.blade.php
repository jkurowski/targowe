                        ...
                        @foreach($list as $page)
                            <tr>
                                ...
                                <td class="option-120">
                                    <div class="btn-group">
                                        @if($page->type == 1)
                                        <a href="{{route('admin.page.edit', ['page' => $page->id, 'lang' => 'en'])}}" class="btn action-button lang-button me-1 d-none" data-toggle="tooltip" data-placement="top" title="Edytuj"><img src="{{ asset('/cms/flags/en.png') }}" alt="Tłumaczenie: en"></a>
                                        ...
                                        @else
                                        <a href="{{route('admin.url.edit', ['url' => $page->id, 'lang' => 'en'])}}" class="btn action-button lang-button me-1 d-none" data-toggle="tooltip" data-placement="top" title="Edytuj"><img src="{{ asset('/cms/flags/en.png') }}" alt="Tłumaczenie: en"></a>
