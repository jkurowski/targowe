            ...
            <div class="card-head container-fluid">
                <div class="row">
                    <div class="col-6 pl-0">
                        <h4 class="page-title"><i class="fe-shopping-bag" aria-hidden="true"></i>Punkty sprzedaży</h4>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    @foreach ($list as $index => $p)
                        <tr id="recordsArray_{{ $p->id }}">
                            ...
                            <td class="option-120">
                                <div class="btn-group">
                                    <a
                                        href="{{ route('admin.developro.investment-sale-point.edit', $p->id) }}"
                                    ...
                                    <form method="POST" action="{{ route('admin.developro.investment-sale-point.destroy', $p->id) }}">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 d-flex justify-content-end">
                    <a href="{{ route('admin.developro.investment-sale-point.create') }}" class="btn btn-primary">Dodaj wpis</a>
                </div>
            </div>
        </div>
    </div>
