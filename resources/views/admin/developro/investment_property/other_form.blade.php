...
@section('content')
    @if(Route::is('admin.developro.investment.others.edit'))
        <form method="POST" action="{{route('admin.developro.investment.others.update', [$investment, $floor, $entry])}}" enctype="multipart/form-data" class="mappa">
            {{method_field('PUT')}}
            @else
                <form method="POST" action="{{route('admin.developro.investment.others.store', [$investment, $floor])}}" enctype="multipart/form-data" class="mappa">
                    @endif
                    @csrf
                    <div class="container">
                        <div class="card">
                            ...
                            <div class="card-body control-col12">
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            <div class="col-4 mb-4">
                                                @include('form-elements.crm.html-select', ['label' => 'Widoczne', 'name' => 'active', 'selected' => $entry->active, 'select' => [
                                                       '1' => 'Tak',
                                                       '0' => 'Nie'
                                                       ]
                                                   ])
                                            ...
                                            <div class="col-4 mb-4">
                                                @include('form-elements.crm.html-select', ['label' => 'Typ powierzchni', 'name' => 'type', 'selected' => $entry->type, 'select' => \App\Helpers\PropertyAreaTypes::getOthers()])
                                            </div>
                                ...
                                <div class="row w-100 form-group">
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                @include('form-elements.crm.input-text', ['label' => 'Nazwa', 'sublabel'=> 'Pełna nazwa', 'name' => 'name', 'value' => $entry->name, 'required' => 1])
                                            </div>

                                            <div class="col-3">
                                                @include('form-elements.crm.input-text', ['label' => 'Nazwa na liście', 'sublabel'=> 'Miejsce parkingowe, Komórka lokatorska itp', 'name' => 'name_list', 'value' => $entry->name_list, 'required' => 1])
                                            </div>

                                            <div class="col-3">
                                                @include('form-elements.crm.input-text', ['label' => 'Numer', 'sublabel'=> 'Tylko numer, bez nazwy', 'name' => 'number', 'value' => $entry->number, 'required' => 1])
                                            </div>
                                            <div class="col-3">
                                                @include('form-elements.crm.input-text', ['label' => 'Kolejność na liście', 'sublabel'=> 'Tylko liczby', 'name' => 'number_order', 'value' => $entry->number_order, 'required' => 1])
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row w-100 form-group">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-3">
                                                @include('form-elements.crm.input-text', ['label' => 'Powierzchnia', 'name' => 'area', 'value' => $entry->area, 'required' => 1])
                                            </div>
                                            <div class="col-3">
                                                @include('form-elements.crm.input-text', ['label' => 'Powierzchnia (szukana)', 'name' => 'area_search', 'value' => $entry->area_search, 'required' => 1])
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row w-100 form-group">
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                @include('form-elements.crm.html-select', ['label' => 'Promocja', 'name' => 'highlighted', 'selected' => $entry->highlighted, 'select' => [
                                                  '0' => 'Nie',
                                                  '1' => 'Tak'
                                                  ]
                                                ])
                                            ...
                                            <div class="col-3">
                                                @include('form-elements.crm.html-input-date', ['label' => 'Data zakończenia promocji', 'sublabel'=> '', 'name' => 'promotion_end_date', 'value' => $entry->promotion_end_date])
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row w-100 form-group">
                                    <div class="col-3">
                                        @include('form-elements.crm.html-select', ['label' => 'Pokaż ceny przy promocji', 'name' => 'promotion_price_show', 'selected' => $entry->promotion_price_show, 'select' => [
                                          '0' => 'Nie',
                                          '1' => 'Tak'
                                          ]
                                        ])
                                    ...
                                    <div class="col-3">
                                        @include('form-elements.crm.html-input-text', ['label' => 'Cena promocyjna', 'sublabel'=> '', 'name' => 'promotion_price', 'value' => $entry->promotion_price])
                                    </div>
                                    <div class="col-3">
                                        @include('form-elements.crm.html-input-text', ['label' => 'Cena 30 dni', 'sublabel'=> '', 'name' => 'price_30', 'value' => $entry->price_30])
                                    </div>
                                </div>

                                <div class="row w-100 form-group">
                                    <div class="col-5">
                                        @include('form-elements.crm.input-text', ['label' => 'Cena brutto', 'sublabel'=> 'Tylko liczby', 'name' => 'price_brutto', 'value' => $entry->price_brutto])
                                    </div>
                                    ...
                                    <div class="col-5">
                                        @include('form-elements.crm.input-text', ['label' => 'Cena netto', 'sublabel'=> 'Tylko liczby', 'name' => 'price', 'value' => $entry->price])
                                    </div>
                                </div>
                                <div class="row w-100 form-group">
                                ...
                                <div class="row w-100 form-group">
                                    @include('form-elements.crm.html-input-file', [
                                ...
                                <div class="row w-100 form-group">
                                    @include('form-elements.crm.html-input-file-pdf', [
                                        'label' => 'Plan .pdf',
                                        'sublabel' =>
                                        'Plan do pobrania',
                                        'name' => 'file_pdf',
