@php
    ...
    $labelClass = 'col-12 col-form-label control-label pb-2 justify-content-start';
...
<div class="{{ $divClass }}">
    {!! Form::text($name, old($name, $value), ['class' => $inputClass, ($required ? ' required' : ''), ($readonly ? ' readonly' : '')]) !!}
</div>
