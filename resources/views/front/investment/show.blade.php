                                        ...
                                        @foreach($floors as $int => $floor)
                                            @if($floor->html)
                                                <area
                                                        ...
                                                        title="<div class='qtip-floor'><h4>{{$floor->name}}</h4></div>"
                                                        alt="floor-{{$int}}"
                                                        data-item="{{$floor->id}}"
                                                        data-slick="{{$int}}"
                                    ...
                                    <div class="apartment-box">
                                        ...
                                        <div class="row apartment-row align-items-lg-center gy-3 gx-3">
                                            ...
                                            <div class="col-12 col-lg-2 d-flex justify-content-center justify-content-lg-end" id="ap-btn">
                                                <a class="btn btn-primary z-1 position-relative" href="{{route('property', [$investment->slug, $p->floor, 'floor_slug' => Str::slug($p->floor->name), $p, 'property_slug' => Str::slug($p->name) ])}}">
                                                    Sprawdź
                                        ...
                                        <!-- MAJOR A TAG -->
                                        <a href="{{route('property', [$investment->slug, $p->floor, 'floor_slug' => Str::slug($p->floor->name), $p, 'property_slug' => Str::slug($p->name) ])}}" class="whole-box z-0"></a>
                                    </div>
                                </div>
                            @endforeach
                        </div>
