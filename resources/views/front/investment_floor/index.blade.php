                ...
                <div class="row mt-5">
                    <div class="col-12">
                        ...
                        <div class="row g-4" id="main-ap-axis">
                            ...
                            <div
                                    data-axis="row"
                                    class="col-12 d-flex justify-content-end main-ap-box-row"
                            >
                                <!-- bg-success - dostępne -->
                                ...
                                <div class="apartment-box">
                                    ...
                                    >
                                        ...
                                        <div class="col-12 col-lg-6 info-box">
                                            ...
                                            <div class="info-text">
                                                ...
                                                <div class="info-text-text">45,5m<sup>2</sup></div>
                                            </div>
                                            <!-- FLOOR -->
                                            <div class="info-text">
                                    ...
                                    <!-- MAJOR A TAG -->
                                    <a href="mieszkanie.html" class="whole-box z-0"></a>
                                </div>
                            </div>
                            <!-- 2 Apartment -->
                            <div
